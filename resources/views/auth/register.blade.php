<x-guest-layout title="Inscription">
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <button type="submit"
            class="w-full bg-gradient-to-r from-emerald-600 to-emerald-600 hover:from-emerald-700 hover:to-emerald-700 text-white font-bold py-3 rounded-xl transition shadow-lg shadow-emerald-600/25 mt-2">
            Créer mon compte
        </button>
    </form>
    ...
    <div class="mt-6 pt-5 border-t border-gray-200 text-center">
        <p class="text-sm text-gray-500">
            ...
            <a href="{{ route('login') }}" class="font-semibold text-emerald-600 hover:text-emerald-700">Se connecter</a>
        </p>
    </div>
</x-guest-layout>
