<x-guest-layout title="Inscription">
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <div>
            ...
            <div class="relative">
                <input x-data x-ref="password" id="password" type="password" name="password" required autocomplete="new-password"
                    placeholder="••••••••"
                ...
                <button type="button" @click="$refs.password.type = ($refs.password.type === 'password' ? 'text' : 'password')"
                    class="absolute inset-y-0 right-0 px-3 text-gray-400 hover:text-gray-600 flex items-center">
                    <svg x-show="$refs.password.type === 'password'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                    <svg x-show="$refs.password.type !== 'password'" x-cloak class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"></path></svg>
                </button>
            </div>
        ...
        <div>
            ...
            <div class="relative">
                <input x-data x-ref="password_confirmation" id="password_confirmation" type="password" name="password_confirmation" required autocomplete="new-password"
                    placeholder="••••••••"
                    class="w-full rounded-xl border border-gray-300 px-4 py-3 pr-12 text-sm outline-none transition focus:ring-2 focus:ring-rose-500 focus:border-rose-500 bg-gray-50 focus:bg-white">
                <button type="button" @click="$refs.password_confirmation.type = ($refs.password_confirmation.type === 'password' ? 'text' : 'password')"
                    class="absolute inset-y-0 right-0 px-3 text-gray-400 hover:text-gray-600 flex items-center">
                    <svg x-show="$refs.password_confirmation.type === 'password'" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                    <svg x-show="$refs.password_confirmation.type !== 'password'" x-cloak class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"></path></svg>
                </button>
            </div>
