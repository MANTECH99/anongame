<x-game-layout title="Messages anonymes">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-3xl p-6 shadow-sm mb-6">
        ...
        <form method="POST" action="{{ route('anonymous.store') }}" class="flex flex-col sm:flex-row gap-3">
            ...
            <button class="bg-rose-600 hover:bg-rose-700 text-white font-semibold px-6 py-2.5 rounded-xl transition">+ Créer</button>
        </form>
    </div>
    ...
    <div class="space-y-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl p-5 shadow-sm">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <a href="{{ route('anonymous.messages', $link) }}" class="{{ $link->unreadCount() ? 'bg-rose-600 hover:bg-rose-700' : 'bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600' }} text-{{ $link->unreadCount() ? 'white' : 'gray-700 dark:text-white' }} text-sm font-semibold py-2 px-4 rounded-xl transition">
